...
public class HyggLimboManager {
    ...
    private final HyggLimbosProcessor processor;
    ...
    public HyggLimboManager(Hyggdrasil hyggdrasil) {
        ...
        this.processor = new HyggLimbosProcessor(this.hyggdrasil.getKubernetes().getClient());
    ...
    public HyggLimbo startLimbo(HyggLimbo.Type type, HyggData data) {
        final HyggLimbo limbo = new HyggLimbo(Hyggdrasil.getConfig().getKubernetes().getResourcesPrefix(), type, data);
        ...
        this.processor.startLimbo(limbo);
